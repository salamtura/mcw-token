...
export const assertEqualBigNumbers = (a, b) => assert.isTrue(Object.is(a.toExponential(12), b.toExponential(12)), `Expected ${a.toExponential(12)} to equal ${b.toExponential(12)}`);
